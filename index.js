...
// Calculate the total amount of money pledged
const totalPledged = GAMES_JSON.reduce((acc, game) => acc + game.pledged, 0);

// Update the raisedCard element with the result and a dollar sign
...
const unfundedGamesString = unfundedGamesCount === 1 
  ? `There is 1 unfunded game. Consider funding it to help make it a reality!` 
  : `There are ${unfundedGamesCount} unfunded games. Consider funding them to help make them a reality!`;
...
// Create a new element for the top pledge game
